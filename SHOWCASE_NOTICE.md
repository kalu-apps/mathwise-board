...
- публичный деплой настроен как whiteboard-only: учитель входит по статичному аккаунту, ученик подключается по временной ссылке приглашения без авторизации.
