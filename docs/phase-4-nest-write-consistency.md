...
1. `NEST_OBJECT_VERSION_STRICT=0|1`
2. `NEST_IDEMPOTENCY_TTL_MS=300000`
3. `NEST_IDEMPOTENCY_MAX_RECORDS=20000`
4. `NEST_IDEMPOTENCY_BODY_FALLBACK=1`
5. `NEST_IDEMPOTENCY_SAMPLE_RATE=1`
