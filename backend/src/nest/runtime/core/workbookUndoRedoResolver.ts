...
import { normalizeWorkbookObjectStackingLayer, normalizeWorkbookObjectZOrder, withWorkbookObjectStackingLayer } from "../../../../../src/features/workbook/model/objectZOrder";
...
const buildHistoryEntryFromEvent = (
  ...
  if (event.type === "board.stroke" || event.type === "annotations.stroke") {
    ...
    const nextObjectBase = { ...currentObject, zOrder };
    const nextObject = hasStackingLayer
