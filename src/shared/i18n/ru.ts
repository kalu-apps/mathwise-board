export const ru = {
  ...
  connectivity: {
    ...
    offlineMessage:
      "Проверьте Wi-Fi или мобильную сеть. Мы продолжим синхронизацию автоматически.",
    degradedTitle: "Соединение заметно нестабильно",
    degradedMessage:
      "Проверьте сеть, VPN или прокси. Мы продолжаем восстанавливать синхронизацию.",
