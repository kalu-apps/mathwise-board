...
export type WorkbookEventType =
  ...
  | "board.stroke.delete" | "board.strokes.translate" | "board.strokes.translate.preview"
  | "board.object.create"
  ...
  | "annotations.stroke.delete" | "annotations.strokes.translate" | "annotations.strokes.translate.preview"
  | "annotations.clear"
  | "document.asset.add"
