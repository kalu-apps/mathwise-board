...
const TEMPLATES: Record<string, Solid3dTemplate> = {
  ...
  oblique_prism: {
    ...
    faces: [{ points: [p(32, 48), p(58, 48), p(72, 64), p(58, 74), p(32, 74), p(18, 64)] }],
    segments: [
      { from: p(32, 48), to: p(58, 48) },
      { from: p(58, 48), to: p(72, 64) },
      { from: p(72, 64), to: p(58, 74) },
      { from: p(58, 74), to: p(32, 74) },
      { from: p(32, 74), to: p(18, 64) },
      { from: p(18, 64), to: p(32, 48), hidden: true },
      { from: p(32, 48), to: p(52, 18), hidden: true },
      { from: p(58, 48), to: p(80, 18) },
      { from: p(72, 64), to: p(94, 34) },
      { from: p(58, 74), to: p(80, 44) },
      { from: p(32, 74), to: p(52, 44) },
      { from: p(18, 64), to: p(38, 34), hidden: true },
      { from: p(52, 18), to: p(80, 18) },
      { from: p(80, 18), to: p(94, 34) },
      { from: p(94, 34), to: p(80, 44) },
      { from: p(80, 44), to: p(52, 44) },
      { from: p(52, 44), to: p(38, 34), hidden: true },
      { from: p(38, 34), to: p(52, 18), hidden: true },
    ],
  },
  triangular_prism: {
    id: "triangular_prism",
  ...
  oblique_triangular_prism: {
    ...
    faces: [{ points: [p(22, 72), p(50, 74), p(34, 46)] }],
    segments: [
      { from: p(22, 72), to: p(50, 74) },
      { from: p(50, 74), to: p(34, 46) },
      { from: p(34, 46), to: p(22, 72) },
      { from: p(22, 72), to: p(50, 44) },
      { from: p(50, 74), to: p(80, 46) },
      { from: p(34, 46), to: p(64, 18) },
      { from: p(50, 44), to: p(80, 46) },
      { from: p(80, 46), to: p(64, 18) },
      { from: p(64, 18), to: p(50, 44), hidden: true },
    ],
  },
  hexagonal_prism: {
    id: "hexagonal_prism",
  ...
  oblique_parallelepiped: {
    ...
    segments: [
      ...
      { from: p(22, 38), to: p(44, 18) },
      { from: p(58, 32), to: p(80, 12) },
      { from: p(64, 72), to: p(86, 52) },
      { from: p(28, 78), to: p(50, 58), hidden: true },
      { from: p(44, 18), to: p(80, 12) },
      { from: p(80, 12), to: p(86, 52) },
      { from: p(86, 52), to: p(50, 58), hidden: true },
      { from: p(50, 58), to: p(44, 18), hidden: true },
    ],
  },
  prism_trapezoid: {
    id: "prism_trapezoid",
