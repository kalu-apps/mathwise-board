...
- `WORKBOOK_SERVER_RECORDING_ENABLED=1`
- `WORKBOOK_RECORDING_LIVEKIT_EGRESS_URL=https://rtc.your-domain.tld`
- `WORKBOOK_RECORDING_TOKEN_SECRET=<random-recording-token-secret>`
- `WORKBOOK_RECORDING_S3_ENDPOINT=https://s3.your-storage.tld`
- `WORKBOOK_RECORDING_S3_REGION=auto`
- `WORKBOOK_RECORDING_S3_BUCKET=<recordings-bucket>`
- `WORKBOOK_RECORDING_S3_ACCESS_KEY=<storage-access-key>`
- `WORKBOOK_RECORDING_S3_SECRET=<storage-secret>`
- `WORKBOOK_RECORDING_S3_FORCE_PATH_STYLE=1`
- `WORKBOOK_RECORDING_PUBLIC_URL_BASE=https://recordings.your-domain.tld`
